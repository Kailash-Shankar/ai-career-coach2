  ...
  <CardContent>
   <div className="h-[400px]">
    ...
    >
      ...
      <Bar dataKey="min" fill="#8884d8" name="Min Salary (K)"  radius={[10, 10, 0, 0]} />
      <Bar dataKey="median" fill="#82ca9d" name="Median Salary (K)"  radius={[10, 10, 0, 0]} />
      <Bar dataKey="max" fill="#ffc658" name="Max Salary (K)"  radius={[10, 10, 0, 0]} />
    </BarChart>
    </ResponsiveContainer>
   </div>
  </CardContent>
